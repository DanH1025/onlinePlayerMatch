...
const {submitBet,completeBet } = require('../controllers/playerController')
const {approveBet} = require('../controllers/adminController')
...
router.post('/completeBet' , authenticateUsers.authenticateUsers , completeBet)
